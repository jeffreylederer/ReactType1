    ...
    return (
        <Layout>
            ...
            <p style={{ width: '100%', textAlign: 'left' }}>
                The source code depository for this application as at <a href="https://github.com/jeffreylederer/BowlingLeagueApp" target="blank">https://github.com/jeffreylederer/BowlingLeagueApp</a>
            </p>
        </Layout>
    );
